...
function check() {
    const inputBundesland = document.querySelector("#bundeslandInfo").value;
    const outputBundesland = document.querySelector("#bundeslandInfoErgebnis");

switch (inputBundesland) {
    
    case "Baden-Württenberg":
        ...
        default:
            outputBundesland.innerHTML = " Kein Bundesland gefunden!";
}
